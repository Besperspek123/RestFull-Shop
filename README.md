...
2. Склонируйте Репозиторий:
   **git clone https://github.com/Besperspek123/RestFull-Shop.git**
3. Перейдите в терминале в корень проекта
4. Пропишите команду **docker-compose up** для поднятия контейнеров
5. Проект будет доступен по ссылке http://localhost:8080

### Документация API
Документация API доступна по адресу (http://localhost:8080/documentation). В ней вы найдете описание всех доступных эндпоинтов, параметры запросов и примеры ответов.
